...
// crear puchero
 ...
 puchero.style.width = "12em";
 puchero.style.height = "6em";
...
// Dibujar una elipse en cada canvas y posicionarlos en una elipse 
for (var i = 0; i < canvases.length; i++) {
  ...
  canvases[i].style.left = Math.cos(2 * Math.PI * i / casillas) * 250 + 250 - 25 + 'px';
  canvases[i].style.top = Math.sin(2 * Math.PI * i / casillas) * 200 + 250  - 25  + 'px';
